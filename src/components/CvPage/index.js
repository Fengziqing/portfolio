            ...
            <div className="work">
                <div className="job-title">
                    <p>Client Engineer<br /> <span className="name-explanation"
                        onclick="navigateToLink('https://zoom.us/')">ZOOM <img
                            src={link} alt=""/></span> <br /><span> HangZhou, China <br />2022 - 2023</span></p>
                    <img className="spot" src={spot} alt="spot" />
                </div>
                <ul className="ul-normal">
                    <li>Led the development of <span className="name-explanation"
                        onclick="navigateToLink('https://github.com/Fengziqing/languageTest')">validation
            ...
            <div className="ocha">
                <div className="school-name">
                    <p>Master degree <br /> <span className="name-explanation"
                        onclick="navigateToLink('https://www.ocha.ac.jp/index.html')">Ochanomizu University <img
                ...
                <ul className="ul-normal">
                    <li>Computer Science Master degree in <span className="name-explanation"
                        onclick="navigateToLink('http://is.ocha.ac.jp/~siio/')">Human-Computer Interaction, Siio Lab
                        <img src={link} alt=""/></span></li>
                    <li><span className="name-explanation"
                        onclick="navigateToLink('https://www.ipsj.or.jp/award/taikaigakusei.html')">Student
                    ...
                    <li><span className="name-explanation"
                        onclick="navigateToLink('https://www.jlpt.jp/e/about/levelsummary.html')">Language
                        Proficiency N1 <img src={link} alt=""/></span> : The highest-level certificate of Japanese
                        proficiency (24.1% Pass Rate)</li>
                </ul>
            </div>
            <div className="download-cv"><button> Download CV</button></div>
        </div>
    </>
)
